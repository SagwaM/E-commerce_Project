...
export default function DashboardLayout({ children, title, userType, userData }) {
  ...
  const recipientSidebarItems = [
    ...
    { icon: "Available Food", label: "Available Food", href: "/dashboard/recipient/available" },
    { icon: "My Requests", label: "My Requests", href: "/dashboard/recipient/requests" },
    { icon: "Settings", label: "Settings", href: "/dashboard/recipient/settings" },
  ];
  
  const ngoSidebarItems = [
    { icon: "Home", label: "Overview", href: "/dashboard/ngo" },
    { icon: "Recipients", label: "Recipients", href: "/dashboard/ngo/recipients" },
    { icon: "Donations", label: "Donations", href: "/dashboard/ngo/donations" },
    { icon: "Impact", label: "Impact", href: "/dashboard/ngo/impact" },
    { icon: "Settings", label: "Settings", href: "/dashboard/ngo/settings" },
  ];
